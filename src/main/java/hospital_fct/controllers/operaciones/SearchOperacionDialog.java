...
public class SearchOperacionDialog extends Dialog<String> implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fieldComboBox.getItems().addAll("Operacion", "Paciente","Hora", "Fecha");
        ...
        setTitle("Buscar");
        setHeaderText("Elija el campo de la operacion a buscar:");
