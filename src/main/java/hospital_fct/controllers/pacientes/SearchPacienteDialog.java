...
public class SearchPacienteDialog extends Dialog<String> implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fieldComboBox.getItems().addAll("Nombre", "Apellido", "Sangre", "Email", "Telefono");
        ...
        setTitle("Buscar");
        setHeaderText("Elija el campo del paciente a buscar:");
